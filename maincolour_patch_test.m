...
% Filename = 'C:\Users\fhaoo\Desktop\baitong\Î¢ÐÅÍ¼Æ¬_20170711214552.png';
picAll = dir(picAddress);
for pic_i = 3:size(picAll,1)
    clear P M N K res_pic Hist maincolor Mmm PP Dis num_k tmp
    try
        P =imread([picAddress '\' picAll(pic_i,1).name]);
